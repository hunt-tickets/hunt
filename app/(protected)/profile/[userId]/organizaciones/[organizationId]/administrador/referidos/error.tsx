...
/**
 * Error boundary for the Referidos page
 *
 * This component catches and handles errors that occur in the referidos page,
...
interface ReferidosErrorProps {
  error: Error & { digest?: string };
  reset: () => void;
}

export default function ReferidosError({ error, reset }: ReferidosErrorProps) {
  const router = useRouter();

  useEffect(() => {
    // Log the error to an error reporting service
    console.error("Referidos page error:", error);
  }, [error]);
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600 dark:text-white/60 leading-relaxed">
                  Lo sentimos, ocurrió un error inesperado al cargar la página de referidos.
