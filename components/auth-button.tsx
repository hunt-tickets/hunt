    ...
    <DropdownMenu>
      ...
      >
        ...
        <div className="p-1">
          ...
          <DropdownMenuItem asChild className="rounded-xl cursor-pointer">
            <Link href={`/profile/${user.id}/organizaciones`} className="flex items-center px-3 py-2">
          ...
          <DropdownMenuItem asChild className="rounded-xl cursor-pointer">
            <Link href={`/profile/${user.id}/entradas`} className="flex items-center px-3 py-2">
              <svg className="mr-2 h-4 w-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
