          ...
          <svg className="h-12 w-12" viewBox="0 0 48 48" fill="none">
            <defs>
              <linearGradient id="phoneGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" style={{ stopColor: "#3b3b3b", stopOpacity: 1 }} />
            ...
            {/* Phone body */}
            <rect x="14" y="4" width="20" height="40" rx="3" fill="url(#phoneGrad)" filter="url(#phoneShadow)"/>
            <rect x="14.5" y="4.5" width="19" height="39" rx="2.5" stroke="#4a4a4a" strokeWidth="0.5"/>
            {/* Screen */}
            <rect x="16" y="8" width="16" height="28" rx="1.5" fill="#0a0a0a"/>
            {/* Home indicator */}
            <rect x="21" y="38" width="6" height="1.5" rx="0.75" fill="#4a4a4a"/>
          </svg>
        );
      case "tablet":
        return (
          <svg className="h-12 w-12" viewBox="0 0 48 48" fill="none">
            ...
            {/* Tablet body */}
            <rect x="8" y="6" width="32" height="36" rx="3" fill="url(#tabletGrad)" filter="url(#tabletShadow)"/>
            <rect x="8.5" y="6.5" width="31" height="35" rx="2.5" stroke="#4a4a4a" strokeWidth="0.5"/>
            {/* Screen */}
      ...
      default:
        return (
          <svg className="h-12 w-12" viewBox="0 0 48 48" fill="none">
            ...
            {/* Monitor screen */}
            <rect x="4" y="6" width="40" height="26" rx="2" fill="url(#monitorGrad)" filter="url(#monitorShadow)"/>
            <rect x="4.5" y="6.5" width="39" height="25" rx="1.5" stroke="#3a3a3a" strokeWidth="0.5"/>
            ...
            <div className="flex items-start gap-4 flex-1">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  {isCurrentSession && (
                    <Badge variant="secondary" className="text-xs px-2 py-0.5 bg-green-500/10 text-green-400 border-green-500/20">
                      Este dispositivo
                    </Badge>
                  )}
                </div>
