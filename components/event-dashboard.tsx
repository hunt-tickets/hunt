            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-white/40">Ventas Brutas</span>
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-white/40">Comisión Pasarela de Pago</span>
                  <span className="font-medium text-red-400">
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    ...
                    {financialReport.org_summary.by_channel.web.gross > 0 && (
                      <div className="p-3 rounded-lg bg-white/[0.02] border border-white/5">
                        <div className="text-xs text-white/40 mb-2">Web</div>
                    ...
                    {financialReport.org_summary.by_channel.app.gross > 0 && (
                      <div className="p-3 rounded-lg bg-white/[0.02] border border-white/5">
                        <div className="text-xs text-white/40 mb-2">App</div>
                        <div className="text-sm font-bold mb-1">
                    ...
                    {financialReport.org_summary.by_channel.cash.gross > 0 && (
                      <div className="p-3 rounded-lg bg-white/[0.02] border border-white/5">
                        <div className="text-xs text-white/40 mb-2">Efectivo</div>
                        <div className="text-sm font-bold mb-1">
